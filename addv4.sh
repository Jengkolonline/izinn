...
add-ip() {
    ...
    git push -f https://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@github.com/Jengkolonline/izinn.git &> /dev/null
    rm -rf /root/ipvps
    clear
    ...
    echo -e "===================================="
    echo -e "  >>>>> LINK INSTALL <<<<<"
    echo -e " sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl unzip && wget https://raw.githubusercontent.com/Jengkolonline/tunneljengkolonline/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh " 
    echo -e "===================================="
    echo -e " TERIMAKASIH TELAH MENNGUNAKAN SCRIP JENGKOLONLINE
    echo -e "===================================="
    echo ""
