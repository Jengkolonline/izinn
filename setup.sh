...
echo "   - Shadowsocks2022 WS TLS      : 443" | tee -a log-install.txt
echo "   - Shadowsocks2022 none TLS.   : 80" | tee -a log-install.txt
echo "   - Shadowsocks2022 Grpc	   : 443" | tee -a log-install.txt
echo "   - Socks5 WS TLS              : 443" | tee -a log-install.txt
echo "   - Socks5 none TLS.          : 80" | tee -a log-install.txt
echo "   - Socks5 Grpc	             : 443" | tee -a log-install.txt
...
echo "   - Psiphon Pro               : 8443" | tee -a log-install.txt
